...
<html lang="en">
	...
	<body class="body">
		<div class="overflow-hidden">
				...
				<div class="container">
					<div
						...
						<div class="space-x-10 d-flex align-items-center">
							...
							<p class="color_white">
								Switch to Dark mode
								<span style="color: rgb(0, 255, 170)">Now </span>
							</p>
						</div>
					...
					<div class="wrapper js-header-wrapper">
						...
						<div class="header__menu">
							<ul class="d-flex space-x-20">
								<li class="has_popup">
									<a class="color_black" href="Home1.html"><i class="ri-home-smile-2-line"></i>&nbsp;Home </a>
								...
								<li>
									<a class="color_black" href="Marketplace.php"> Marketplace</a>
								</li>
								<!-- <li>
									<a class="color_black" href="Collections.html"> Collections</a>
								</li> -->
								<li>
									<a class="color_black" href="Profile.php"> Profile</a>
								</li>
								<!-- <li>
						...
						<div class="header__btns">
							...
							if (isset($_SESSION["user_id"])) {
								// User is already logged in, display something else or nothing
							} else {
								// User is not logged in, show the login button
								echo '<a class="btn btn-grad btn-sm" href="login.php">
									<i class="ri-wallet-3-line"></i>
									Connect
								</a>';
							}
			...
			</header><div class="hero__1">
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-6">
								<div class="hero__left space-y-20">
									<h1 class="hero__title">
										Bienvenue sur EnsahTicket 
									</h1>
									<p class="hero__text txt">Votre Place de Marché pour les Billets de Restaurants.

										Explorez, Réservez, Partagez : Vivez la Gastronomie Autrement !
										
										Rejoignez notre communauté dès aujourd'hui !</p>
									<div class="space-x-20 d-flex flex-column flex-md-row
										sm:space-y-20">
										<a class="btn btn-primary" href="Marketplace.html">Marketplace
											</a>
										<a class="btn btn-white" href="Upload.html">
											Vendre Ticket</a>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<img class="img-fluid w-full" id="img_js"
									src="assets/img/bg/in_hero1.svg"
									alt="">
							</div>
						</div>
...
<div id="marketplaceItemContainer"> -->
	<!-- The content of the marketplace item will be loaded here -->
  ...
  <script>
	$(function() {
	  $("#marketplaceItemContainer").load("Marketplace.php .row.mb-30_reset");
	});
  </script> -->
  <!-- <br>
					<div class="d-flex justify-content-center">
						<a href="Marketplace.php" class="btn btn-sm btn-white">
			...
			<div class="call2action">
				<div class="container">
					<div class="row justify-content-between align-items-center
						...
						<div class="col-md-6">
							<div class="space-y-20">
								<h1 class="text-white">Avec EnsahTicket </h1>
								<p class="color_text section__text">Découvrez les meilleurs billets 
									de restaurants en un clin d'œil. 
									Prêt à réserver votre prochain festin ?</p>
						...
						<div class="col-md-auto">
							<img class="img-fluid img__logo"
								src="assets/img/logos/Logo_illustrstion.svg"
								alt="...">
						</div>
					</div>
				</div>
...
?>
		...
		<script>
				...
				document.getElementById("img_js").src = "assets/img/bg/in_hero1_dark.svg"
			
			
			});
			$(".light").on('click', function (e) {
				document.getElementById("img_js").src = "assets/img/bg/in_hero1.svg"
			});
			</script>
